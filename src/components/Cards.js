    ...
    { loading ? <div className=' w-full flex justify-center items-center h-96'><ThreeDots height={40} color='white'/> </div> : 
        data.map((e,i) => {
            return (
                ...
                <div key={i} className='card shadow-lg rounded-lg p-2 hover:-translate-y-3 cursor-pointer  mt-6 transition-all duration-500 md:mx-3 mx-auto w-[350px] md:w-[200px]  '>
            <div className=' font-bold '>
                <img className='h-60 md:h-72 w-auto m-auto md:m-0' src={e.imageUrl} alt="Movie Poster" />
